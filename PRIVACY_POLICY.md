...
- **Yaklaşık konum** — IP adresinden çıkarılan ülke/bölge düzeyinde
- **Cihaz ve kullanım bilgileri** — cihaz modeli, işletim sistemi sürümü,
  reklamın gösterilip gösterilmediği gibi teknik veriler
...
Android'de **Ayarlar → Google → Reklamlar** yolundan reklam kimliğinizi
sıfırlayabilir ya da kişiselleştirilmiş reklamları kapatabilirsiniz.

## Çocuklar

Oyun belirli bir yaş grubuna yönelik değildir ve bilerek 13 yaşın altındaki
kullanıcılardan veri toplamaz. Çocuğunuzun verisiyle ilgili bir kaygınız
varsa aşağıdaki adresten bize ulaşın.
